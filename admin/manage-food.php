...
<div class="dash">
  ...
  <a href="manage-feedback.php"> Manage Feedback</a>
    ...
    <div style="width: 100%;display:flex;justify-content:center;flex-direction:column ;align-items:center;" class="admin-page">
        <h2 style="margin-bottom:2.5rem;" >Manage Food</h2>
       
        <a style="background-color: #E32636;width: 400px; height: 50px; font-weight:600; color:whitesmoke; padding:1rem 4rem;"  href="<?php echo URL; ?>admin/add-food.php">Add New Food</a>
                ...
                if ($count > 0) {
                  while ($rows = mysqli_fetch_assoc($res)) {
                    ...
                    <tr>
                      ...
                      <td><a style="background-color: green; font-weight:600; color:whitesmoke; padding:0.8em;" href="<?php echo URL; ?>admin/update-food.php?id=<?php echo $id; ?>">Update </a>
                      <a style="background-color: red; font-weight:600; color:whitesmoke; padding:0.8em;" href="<?php echo URL; ?>admin/delete-food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" >Delete</a>
                  ...
                  // echo "<div style='background-color:red; position:absolute;top:200px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px;' class='msg'></div>";
                }
              ?>
