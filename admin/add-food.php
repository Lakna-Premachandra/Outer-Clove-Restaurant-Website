        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                if ($image_name != "") {
                    ...
                    $extension = end($image_name_parts);
                    ...
                    if ($upload == false) {
                        $_SESSION['upload'] = "<div style='background-color:red; position:absolute;top:380px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px; left:820px;' class='msg'>Failed. Image Not Found..!!</div>";
            ...
            $out_stock = isset($_POST['out_stock']) ? $_POST['out_stock'] : "no";
            ...
            if ($res2 == true) {
                $_SESSION['add'] = "<div style='background-color:green; position:absolute;top:380px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px; left:820px;'>Successfully Added Food.</div>";
                header('location:' . URL . 'admin/manage-food.php');
            } else {
                $_SESSION['add'] = "<div style='background-color:red; position:absolute;top:380px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px;left:820px;' class='msg'>Failed to Add.Try Again..!!</div>";
                header('location:' . URL . 'admin/add-food.php');
            }
        }
        ?>
