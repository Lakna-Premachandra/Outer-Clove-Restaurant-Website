...
if (isset($_GET['id'])) {
    ...
    if ($count == 1) {
        ...
        $_SESSION['not-found'] = "<div style='background-color:red; position:absolute;top:380px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px;left:820px;' class='msg'>Failed. Image Not Found..!!</div>";
    ...
    ?>
      ...
      <?php
        if (isset($_POST['submit'])) {
            ...
            if (!$res_image) {
                $_SESSION['update'] = "<div style='background-color:red; position:absolute;top:380px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px;left:820px;' class='msg'>Failed. Image Not Found..!!</div>";
            ...
            if ($res2 !== false && mysqli_affected_rows($conn) > 0) {
                $_SESSION['update'] = "<div style='background-color:green; position:absolute;top:380px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px;left:820px;' class='msg'>Successfully Updated.</div>";
                header("location:" . URL . 'admin/manage-food.php');
            } else {
                $_SESSION['update'] = "<div style='background-color:red; position:absolute;top:380px;color:whitesmoke;padding:1rem;font-size:1.3rem;border-radius:10px;left:820px;' class='msg'>Failed to Update..!!</div>";
                header("location:" . URL . 'admin/manage-food.php');
            }
        }
        ?>
